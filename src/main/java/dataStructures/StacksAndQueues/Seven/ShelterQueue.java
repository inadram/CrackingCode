...
public class ShelterQueue {
	...
	public Animal deQueueDog() {
		...
		for (int i = 0; i < animals.size(); i++) {
			if (animals.get(i).type.equals("dog") && animals.get(i).age > oldest) {
				oldest = animals.get(i).age;
				id = i;
			}
		}
	...
	public Animal deQueueCat() {
		...
		int id = -1;
		for (int i = 0; i < animals.size(); i++) {
			if (animals.get(i).type.equals("cat") && animals.get(i).age > oldest) {
				oldest = animals.get(i).age;
				id = i;
			}
		}
