...
import main.dataStructures.TreesAndGraphs.Eight.SubTreeValidation;
...
public class SubTreeValidationTest {
    ...
    public void test_if_t2_is_a_subtree_of_t1(){
        ...
        */
        ...
        SubTreeValidation subTreeValidation=new SubTreeValidation();
