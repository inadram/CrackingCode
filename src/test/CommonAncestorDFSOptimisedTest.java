...
import main.dataStructures.TreesAndGraphs.Seven.CommonAncestorDFSOptimised;
import org.junit.Test;

import static org.junit.Assert.assertEquals;

public class CommonAncestorDFSOptimisedTest {
    ...
    public void test_find_common_ancestor_between_two_node(){
        ...
        */
        ...
        CommonAncestorDFSOptimised commonAncestor = new CommonAncestorDFSOptimised();
//        assertEquals(node_70, commonAncestor.find(treeNode, node_88,node_66));
//        assertEquals(node_70, commonAncestor.find(treeNode,node_80,node_68));
        assertEquals(null, commonAncestor.find(treeNode,node_300,node_68));
    }
