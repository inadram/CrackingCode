...
import main.dataStructures.TreesAndGraphs.Nine.SumOfTreeNodeLevel;
import org.junit.Test;

import static org.junit.Assert.assertEquals;

public class SumOfTreeNodeLevelTest {
    ...
    public void find_all_path_of_specific_sum(){
        ...
        */
        ...
        SumOfTreeNodeLevel sumOfTreeNode = new SumOfTreeNodeLevel();
        assertEquals(3, sumOfTreeNode.findSum(t1, 45).size());
    }
